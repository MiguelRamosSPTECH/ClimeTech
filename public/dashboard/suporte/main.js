...
// rota para receber perguntas e gerar respostaIas
app.post("/perguntar", async (req, res) => {
    const pergunta = req.body.pergunta;

    try {
        const resultado = await gerarrespostaIa(pergunta);
        res.json({ resultado });
    } catch (error) {
...
// função para gerar respostaIas usando o gemini
async function gerarrespostaIa(mensagem) {
    ...
    try {
        ...
        const respostaIa = (await modeloIA).text;
