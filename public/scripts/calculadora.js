    ...
    function calcularLucro() {
        ...
        var perdaEstimada = (porcentagemIngressoAnual * 0.27)
        var recuperadoClimetech = (perdaEstimada * 0.80)
            ...
            ` 
                <div class="div_resposta_simulador">
                    <div>
                        ...
                        <p>
                            2. Isso gera uma <span>receita média de R$${((lucroIngressoAnual + lucroParceriaAnual)).toLocaleString('pt-BR')}</span> por ano com ingressos e parcerias comerciais.
                        </p>
                    
                        <p>
                            3. No entanto, estudos mostram que estádios com <span style="color:red;">má gestão térmica perdem até 27%</span> do lucro anual, resultando na queda da compra dos ingressos: <span style="color:red">R$${perdaEstimada.toLocaleString('pt-br')}</span>
                        </p>                
                    
                        <p>
                            4. É possível <span>evitar até 
                            80% dessas perdas</span>, resultando em uma recuperação de aproximadamente <span>R$${recuperadoClimetech.toLocaleString('pt-br')}</span> por ano. 
                        </p> 
                    </div>       
                </div>
            `;
